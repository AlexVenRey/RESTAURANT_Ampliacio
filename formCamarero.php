...
<head>
    ...
    <title>Formulario Camareros</title>
</head>
<body>
    <div class="container">
        <div class="imgIndex">
        ...
        <form id="login" class="login" method="POST" action="./Procesos/procesoLoginCamarero.php">
            <label>Nombre de usuario(Camarero):</label>
            ...
            <br>
            <label>Contraseña(Camarero):</label>
